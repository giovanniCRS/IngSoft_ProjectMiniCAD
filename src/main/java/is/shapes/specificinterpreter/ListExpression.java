...
public class ListExpression extends TerminalExpression {

    public ListExpression(StreamTokenizer tokenizer) throws Exception {
    ...
    public void interpret(Context context) {
        ...
        Command command = new ListCommand(context.getPanel(), target);
